...
NotificationsComponent.prototype.presentLocalNotification = function(
  details: Object
) {
...
NotificationsComponent.prototype.checkPermissions = function(
  callback: Function
) {
  RNPushNotification.checkPermissions().then(alert => callback({ alert }));
};

NotificationsComponent.prototype.addEventListener = function(
  type: string,
  handler: Function
) {
  var listener;
  if (type === "notification") {
    ...
    listener = DeviceEventEmitter.addListener(REMOTE_FETCH_EVENT, function(
      notifData
    ) {
...
NotificationsComponent.prototype.removeEventListener = function(
  type: string,
  handler: Function
) {
...
NotificationsComponent.prototype.registerNotificationActions = function(
  details: Object
) {
  RNPushNotification.registerNotificationActions(details);
};

NotificationsComponent.prototype.registerNotificationDismiss = function() {
  RNPushNotification.registerNotificationDismiss();
};
